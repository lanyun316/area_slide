...
<script lang="js">
	...
	function refresh(vm){
		   var eunitl=vm.eunitl,inilength=vm.inilength,dListset=vm.dListset,deg=vm.deg;
			...
			var focuslength=dListset.indexOf(vm.focusData)-inilength;
	 ...
	 function cfocusData(){
		  var vm=this;
		  var cellstep=vm.cellstep,eunitl=vm.eunitl,inilength=vm.inilength,deg=vm.deg;
	...
	function end(e){
	  ...
	  function move(e){
	    ...
	    vm.moveY= e.changedTouches[0].clientY/remcell -  vm.startY;
	    vm.aY = parseInt(vm.moveY) + parseInt(vm.Y);
